...
class ConflictError(AppError):
    def __init__(self, message: str = "The request conflicts with the current state."):
...
def _response(status: int, code: str, message: str, details=None) -> dict:
    ...
    # CORS header included so the browser can READ error responses (a 500
    # without it surfaces as an opaque "Failed to fetch" in the SPA).
